...
SCHEMA = {
    ...
    "function": {
        ...
        "description": (
            ...
            "A pixel path has to be resolved into a rectangle first, and one resolved onto the "
            "wrong row is a data accident rather than a stray click. Note that del does not use "
            "the Recycle Bin (measured: the bin's item count does not move) — for anything of the "
